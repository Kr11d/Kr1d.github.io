                    ...
                    <div class="w70">
                        <div id="menu">
                            ...
                            <ul class="{active:menu==1}" v-if="parent.user && parent.user.type && parent.user.type='admin'">
                                <li v-if="menu==1" class="al"><i class="fas fa-times" @click="menu=0"></i></i>
                                <li><router-link :class="{'router-link-active': Sroute.path.search('campaign')==1}" to="/campaigns"><i class="fas fa-bullhorn">
                                <li><router-link :class="{'router-link-active': Sroute.path.search('user')==1}" to="/users"><i class="fas fa-users"></i> Users</li>
                            </ul>
                            <ul class="{active:menu==1}" v-if="parent.user && parent.user.type && parent.user.type!='admin'">
