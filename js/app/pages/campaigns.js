                    ...
                    <div class="flex body"> 
                        <div class="w30 ar filchart"> 
                            <div class="itemchart ptb10" v-if="all"> 
                                <toogle:v-model="all" @update:modelValue="all = $event; checkAll(Sevent)" /> 
                                All 
                            </div> 
                            <div class="itemchart ptb10" v-if="data.items[iChart].sites" v-for="s in data.items[iChart].sites"> 
                                <toogle :v-model="s.include" @update:modelValue="s.include = Sevent;parent.formData = data.items[iChart]; get()" /> 
                                {{s.site}} 
                            </div> 
                        </div> 
